...
import { createCampanha, deleteCampanha, getCampanhaById, listCampanha, updateCampanha } from "../services/campaign.services.js";
...
export const getCampanhaByIdController = async(req: Request, res: Response) => {
    try {
